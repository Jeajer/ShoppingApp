...
import Animated, { useAnimatedGestureHandler, useSharedValue, useAnimatedStyle, PanGestureHandlerGestureEvent, runOnJS } from "react-native-reanimated";
...
const PriceRangeSelector = ({
    ...
    const startHandlerGesture = useAnimatedGestureHandler({
    ...
    const endHandlerGesture = useAnimatedGestureHandler({
        onStart(event, context){
    ...
    return(
        <View style={{paddingHorizontal: 24 }}>
          ...
          <View 
            ...
            <PanGestureHandler onGestureEvent={startHandlerGesture}>
            ...
            <PanGestureHandler onGestureEvent={endHandlerGesture}>
            ...
            {/* <Text style={{ position: "absolute", top: 14, left: 0, color: theme.colors.text, opacity: 0.5 }}>${minPrice}</Text>
            <Text style={{ position: "absolute", top: 14, right: 0, color: theme.colors.text, opacity: 0.5 }}>${maxPrice}</Text> */}
          </View>  
        </View>
    );
}
        ...
        <View 
            ...
            <View
                ...
                <Text numberOfLines={1}
                    style={{color: theme.colors.text}}>{label}</Text>
            </View>
        </View>           
      </View>  
    );
